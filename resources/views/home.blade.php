     ...
     <div class="fun-facts-section" id="fun-facts">
        <div class="container">
            ...
            <div class="row fun-facts-timer">
                <div class="col-md-3">
                    <div class="radial">
                        <span class="timer" data-from="0" data-to="20000" data-speed="3000">+20000</span>
                        <h4>{{$homesetting->count_description1}}</h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="radial">
                        <span class="timer" data-from="0" data-to="2140000" data-speed="3000">+2140000</span>
                ...
                <div class="col-md-3">
                    <div class="radial">
                        <span class="timer" data-from="0" data-to="102000" data-speed="2500">+102000</span>
                ...
                <div class="col-md-3">
                    <div class="radial">
                        <span class="timer" data-from="0" data-to="45" data-speed="4000">45</span>
