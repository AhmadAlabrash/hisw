...
<body style="background-color: #0d1421;" class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>

    <header class="header">

        

        <div class="header__content__venor" style="background-color: #0d1421;">
            <div class="header__logo">
                <a href="{{url('/')}}" title="{{$setting->title}}">
                    <img  class="img-fluid logo-front" src="{{$setting->photo ? '/images/media/' . $setting->photo->file : '/img/200x200.png'}}" alt="logo">
                </a>
            </div>

                     
            <form  class="header__search__venor" method="GET">
                <input id="search" type="text" name="term" placeholder="Search for article">
    ...
    <div class="typed-section" style="background-color: #0d1421;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
